...
from tasks.task8.task8 import QuizGenerator
...
class QuizManager:
    ...
    def next_question_index(self, direction=1):
        ...
        """
        # Ensure st.session_state["question_index"] is initialized before calling this method
        if "question_index" not in st.session_state:
            st.session_state["question_index"] = 0
        
        # Adjust the question index based on the provided direction
